                    ...
                    <tr key={event._id || Math.random()} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                        ...
                        <button
                          ...
                          className="inline-flex items-center px-3 py-1 bg-red-100 text-red-800 hover:bg-red-200 rounded text-sm"
                        >
                          Delete
                        </button>
                      </td>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full mx-4">
            ...
            <p className="text-sm text-gray-600 mb-6">
              Are you sure you want to delete this event? This action cannot be undone and will remove all associated attendance records.
            </p>
